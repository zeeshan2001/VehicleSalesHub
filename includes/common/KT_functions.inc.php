...
function KT_SessionKtBack($newUrl) {
	...
	if (!isset($_SESSION['KT_backArr'])) {
		...
		$toldUrl = htmlspecialchars(KT_addReplaceParam($oldUrl, '/^pageNum_.*$/i'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, '/^totalRows_.*$/i'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, '/^sorter_.*$/i'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, '/^show_all_.*$/i'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, '/^show_filter_.*$/i'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, '/^reset_filter_.*$/i'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, 'isFlash'));
		$toldUrl = htmlspecialchars(KT_addReplaceParam($toldUrl, session_name()));

		$tnewUrl = htmlspecialchars(KT_addReplaceParam($newUrl, '/^pageNum_.*$/i'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, '/^totalRows_.*$/i'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, '/^sorter_.*$/i'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, '/^show_all_.*$/i'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, '/^show_filter_.*$/i'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, '/^reset_filter_.*$/i'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, 'isFlash'));
		$tnewUrl = htmlspecialchars(KT_addReplaceParam($tnewUrl, session_name()));
