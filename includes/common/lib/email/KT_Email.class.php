...
class KT_Email
{
	...
	function loadPEARclasses() {
		$KT_PEAR_dependecies = array(
			...
			'Auth_SASL' => 'Auth/SASL2.php',
			'Auth_SASL_Common' => 'Auth/SASL2/Common.php',
			'Auth_SASL_Anonymous' => 'Auth/SASL2/Anonymous.php',
			'Auth_SASL_Login' => 'Auth/SASL2/Login.php',
			'Auth_SASL_Plain' => 'Auth/SASL2/Plain.php',
			'Auth_SASL_CramMD5' => 'Auth/SASL2/CramMD5.php',
			'Auth_SASL_DigestMD5' => 'Auth/SASL2/DigestMD5.php'
		);
