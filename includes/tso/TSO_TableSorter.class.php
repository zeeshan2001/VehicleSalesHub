...
class TSO_TableSorter {
	...
	var $sorterName;
	var $defaultColumn = "";
    public function __construct($rsName, $sorterName) {
	...
	function getSortLink($column) {
	  ...
	  //$url = htmlspecialchars(KT_addReplaceParam(KT_getFullUri(), $sorter_reference, $paramVal));
		$url = strip_tags(KT_addReplaceParam(KT_getFullUri(), $sorter_reference, $paramVal));
