...
class tNG_log {
	 ...
	 * @access public
	 */
	//(C NIELD FIX - THIS LINE IS OLD CODE - NEW LINE IS BELOW)   function log($className, $methodName=NULL, $message=null) {
	 ...
	 * @access public
	 */
	//(C NIELD FIX - THIS LINE IS OLD CODE - NEW LINE IS BELOW)   function getResult($mode, $uniq='') {
