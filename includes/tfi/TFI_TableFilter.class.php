...
class TFI_TableFilter {
	...
	function getShowFilterLink() {
		...
		if (isset($_GET[$show_filter_reference])) {
			$url = htmlspecialchars(KT_addReplaceParam(KT_getFullUri(), $show_filter_reference));
		} else {
			$url = htmlspecialchars(KT_addReplaceParam(KT_getFullUri(), $show_filter_reference, "1"));
		}
	...
	function getResetFilterLink() {
		...
		if (isset($_GET[$reset_filter_reference])) {
			$url = htmlspecialchars(KT_addReplaceParam(KT_getFullUri(), $reset_filter_reference));
		} else {
			$url = htmlspecialchars(KT_addReplaceParam(KT_getFullUri(), $reset_filter_reference, "1"));
			$url = htmlspecialchars(KT_addReplaceParam($url, '/pageNum_.*/'));
			$url = htmlspecialchars(KT_addReplaceParam($url, '/totalRows_.*/'));
		}
