...
//Only these origins are allowed to upload images *
  $accepted_origins = array("http://localhost", "http://127.0.0.1", "https://www.cardashboard.co.uk", "https://desk.cardashboard.co.uk", "http://192.168.1.1", "http://example.com");

  // Set the destination folder for image
  $month = strtolower(date('M'));
  $year = date('Y');
  $newspath = "../../../ukcd/img/news/";
  //$newspath = "../../img/news/";
  ...
  if (is_uploaded_file($temp['tmp_name'])){
    ...
    */
    ...
    $domainpath = 'https://www.cardashboard.co.uk/';
    $basenewspath = 'img/news';
    $passpath = $domainpath.'/'.$basenewspath .'/'.$year.'/'.$month.'/'.$tempname;
