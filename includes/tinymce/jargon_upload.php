...
//Only these origins are allowed to upload images *
  $accepted_origins = array("https://espo.ukcardiscount.uk", "https://www.ukcardiscount.uk");

  // Set the destination folder for image
	$month = strtolower(date('M'));
//$month = 'sep';
  $year = date('Y');
  $newspath = "../../../../public_html/img/jargon/";
  //$newspath = "../../img/news/";
  ...
  if (is_uploaded_file($temp['tmp_name'])){
    ...
    */
    ...
    $basenewspath = 'img/jargon';
    $passpath = '/'.$basenewspath .'/'.$year.'/'.$month.'/'.$tempname;
