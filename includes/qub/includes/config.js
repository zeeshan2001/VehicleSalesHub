...
// implemented:
locales["QuB cannot edit queries saved with QuB versions greater than [%s]."] = "QuB cannot edit queries saved with QuB versions greater than [%s].";
locales["QuB cannot edit queries saved with QuB versions prior to version [%s]."] = "QuB cannot edit queries saved with QuB versions prior to version [%s].";
...
locales["You must restart QuB to use the imported relations."] = "You must restart QuB to use the imported relations.";
...
locales["Are you sure you want to close QuB?"] = "Are you sure you want to close QuB?";
...
//QuB Edit Table Alias - 045106_WorkDBTables.htm#Edit_Table_Alias
help_topics["qub.dlg.changetablealias"] = "045106_WorkDBTables.htm#Edit_Table_Alias";
