...
function updateWindowTitle(str) {
	...
	document.title = "InterAKT Online :: Query Builder :: "+str;
}
...
function QueryBuilderSignature() {
	return "MX Query Builder - version [" + getQUBVersion() + "].";
}
...
function showQUBHelp(topicID) {
	...
	openHelpWindowIT(HELP_SITE_ROOT + help_topics[topicID].toLowerCase(), 650, 490);
	return true;
}
