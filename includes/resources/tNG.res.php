<?php
$res = array(
'ERROR_LABEL' => '<i class="fas fa-exclamation-circle fa-2x"></i>',
...
'LOGIN_MESSAGE_LABEL' => '<i class="fas fa-exclamation-circle fa-2x"></i>',
...
'LOGIN_MESSAGE__REG_ACTIVATE' => 'New admin user created. User will receive an activation e-mail to complete the process',
'LOGIN_MESSAGE__REG_EMAIL' => 'New admin user created, an email has been sent to the user with login details',
'LOGIN_MESSAGE__REG' => 'New admin user has been created',
'LOGIN_MESSAGE__ACTIVATED' => 'Your account was activated. Please login.',
'LOGIN_MESSAGE__FORGOT' => 'Check your email for password reset',
'LOGIN_MESSAGE__DENIED' => 'You do not have sufficient permissions to access this page. Please login or ask an admin to grant you access',
