...
'EMAIL_ERROR_FOLDER' => 'An error occured when reading the folder with the attachment %s, %s.',
'MAX_FILES_NO_REACHED' => 'Maximum number of files has been reached (%s)',
'FOLDER_DEL_SECURITY_ERROR' => 'Folder delete error. Security Error.',
'FOLDER_DEL_SECURITY_ERROR_D' => 'Folder delete error. Security Error. Folder \'%s\' is out of base folder \'%s\'.',
