...
class tNG_DynamicThumbnail {
	 ...
	 * @access public
	 */
	 public function __construct($relpath, $id) {
	 ...
	 */
		...
		if (substr($fullFileName, 0, strlen($fullFolder)) != $fullFolder) {
			if ($GLOBALS['tNG_debug_mode'] == 'DEVELOPMENT') {
				$ret = $relpath . "includes/tng/styles/cannot_thumbnail.gif\" />Security error. The folder '".$fullFileName."' is out of base folder '".$fullFolder."'<img style=\"display:none\" src=\"".$relpath."includes/tng/styles/cannot_thumbnail.gif";
			} else {
