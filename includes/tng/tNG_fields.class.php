...
class tNG_fields extends tNG {
   ...
   */
    ...
    function getPrimaryKeyValue() {
       if (isset($this->primaryKeyColumn['value']) && is_numeric($this->primaryKeyColumn['value'])) {
           return $this->primaryKeyColumn['value'];
       } else {
           return null;
       }
   ...
   */
	 ...
	 * @access public
	 */
	//(C NIELD FIX - THIS LINE IS OLD CODE - NEW LINE IS BELOW)   function getFieldError($fName) {
